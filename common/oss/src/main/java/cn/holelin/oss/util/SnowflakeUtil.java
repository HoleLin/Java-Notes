 ...
 * @Description: 雪花算法工具类
 * @Author: HoleLin
 * @CreateDate: 2022/6/28 17:39
 * @UpdateUser: HoleLin
 * @UpdateDate: 2022/6/28 17:39
 * @UpdateRemark: 修改内容
 * @Version: 1.0
 */
@Slf4j
public class SnowflakeUtil {
    ...
    public static int getWorkId() {
        try {
            ...
            return new SecureRandom().nextInt(WORK_RANDOM);
        }
    }
    ...
    public static int getDataId() {
        try {
            ...
            return new SecureRandom().nextInt(DATA_RANDOM);
        }
    }
    ...
    public static void main(String[] args) {
        ...
        log.debug("共生成id[" + ids.size() + "]个，花费时间[" + (end - start) + "]毫秒");
        log.debug("{}", ids);
    }
}
